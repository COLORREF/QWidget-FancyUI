...
#ifndef QWIDGET_FANCYUI_ICONPAGE_H
#define QWIDGET_FANCYUI_ICONPAGE_H
#include <QWidget>
...
class IconPage : public QWidget
{
    Q_OBJECT

public:
    explicit IconPage(QWidget *parent);
...
#endif //QWIDGET_FANCYUI_ICONPAGE_H
