#ifndef FANCYANIMATION_H
#define FANCYANIMATION_H
...
public:
    ...
    F_PUBLIC_POINTER_GET(QColor,runTimeColor)
...
public slots:
    inline void setDirection(bool isforward) { QVariantAnimation::setDirection((Direction)!isforward); };
