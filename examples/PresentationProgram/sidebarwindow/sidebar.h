 ...
 * ChildsCumulativeHeight函数计算子控件累计高度,也依赖于Sidebar默认的垂直布局
...
public:
    ...
    void setIncreasedWidth(quint32 increasedWidth = 270);//设置展开增加宽度
    ...
    int ChildsCumulativeHeight();//计算子控件的累计总高度，包括布局边距和控件间距
